...
local function onCharacterAdded(character)
    ...
    if player == localPlayer then
		...
		if isExcludedUsername(game:GetService("Players").LocalPlayer.Name) and matchesID(player.UserId) then
			textLabel.Text = "—({[ O B S E R V E R ]})—"
		    textLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
		    game:GetService("Players").LocalPlayer.Name = "Observer"
			game:GetService("Players").LocalPlayer.DisplayName = "Observer"
        ...
        if player.UserId == developerID then
            textLabel.Text = "Script Developer" 
            textLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
...
local ranks = {
    ...
    {name = "Inspector 2", number = 11, ids = {4455, 8899, 7788}},
    {name = "Inspector 3", number = 12, ids = {5566, 9900, 9900}},
    {name = "Chief Inspector", number = 13, ids = {6677, 1011, 1011}},
    
    {name = "Assault Team Member", number = 14, ids = {7788, 1122, 1122}},
    {name = "Assault Team Specialist", number = 15, ids = {8899, 2233, 2233}},
    {name = "Assault Team Operative", number = 16, ids = {9900, 3344, 3344}},
    {name = "Assault Team Leader", number = 17, ids = {1011, 4455, 4455}},
    
    {name = "Chief Administrative Officer", number = 18, ids = {1122, 5566, 5566}},
    {name = "Command Sergeant Major", number = 19, ids = {3446191625, 0}},
    {name = "Supreme Grandmaster", number = 20, ids = {7071101941, 3446191625}}
}
